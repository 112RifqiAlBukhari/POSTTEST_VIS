...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        ' btnTransaksi
        ' 
        btnTransaksi.BackColor = Color.Lime
        btnTransaksi.FlatAppearance.BorderColor = Color.FromArgb(CByte(0), CByte(90), CByte(180))
        btnTransaksi.FlatStyle = FlatStyle.Flat
        btnTransaksi.Font = New Font("Segoe UI", 9F, FontStyle.Bold)
        ...
        dgvBahan.DefaultCellStyle = DataGridViewCellStyle8
        ...
        lblJudul.Location = New Point(23, 9)
        lblJudul.Name = "lblJudul"
        lblJudul.Size = New Size(460, 37)
        lblJudul.TabIndex = 18
        lblJudul.Text = "📋 Input Penambahan Bahan Baku"
        ' 
        ' Form2
        ' 
